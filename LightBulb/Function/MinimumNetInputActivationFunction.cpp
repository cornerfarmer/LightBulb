...
double MinimumNetInputActivationFunction::execute(double input, AbstractThreshold* threshold)
{
...
double MinimumNetInputActivationFunction::executeDerivation(double input, AbstractThreshold* threshold)
{
