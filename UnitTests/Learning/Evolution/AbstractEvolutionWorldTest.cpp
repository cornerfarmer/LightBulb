...
TEST_F(AbstractEvolutionWorldTest, getHighscoreList)
{
	...
	EXPECT_CALL(*evolutionWorld, getScore(testing::Ref(object1))).WillRepeatedly(testing::Return(1));
	EXPECT_CALL(*evolutionWorld, getScore(testing::Ref(object2))).WillRepeatedly(testing::Return(5));
	EXPECT_CALL(*evolutionWorld, getScore(testing::Ref(object3))).WillRepeatedly(testing::Return(-2));
